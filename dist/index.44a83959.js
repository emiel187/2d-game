...
var _gameOverJs = require("./screens/game-over.js");
class Game {
            ...
            for(let y = 0; y < level.layout.length; y++)for(let x = 0; x < level.layout[y].length; x++){
                ...
                switch(cell){
                    ...
                    case "G":
                        ...
                        break;
                    case "O":
                        this.obstacles.push(new (0, _obstacleJsDefault.default)(position.x, position.y, "normal", this.assets));
                        break;
                    case "C":
    ...
    checkCollisions() {
        ...
        this.guards.forEach((guard, index)=>{
            (0, _gameJs.isColliding)(playerPosition, guard.getPosition());
        });
...
class Player extends (0, _entityDefault.default) {
    #health;
    #speed;
    #blockedDirections;
    ...
    draw(ctx) {
        ...
        if (this.movement === "left") {
            ctx.scale(-1, 1);
            ctx.drawImage(spriteSheet, spriteX, spriteY, spriteWidth, spriteHeight, -this._position.x - this._width, this._position.y, (0, _settings.canvasSettings).cellWidth, (0, _settings.canvasSettings).cellHeight);
        } else ctx.drawImage(spriteSheet, spriteX, spriteY, spriteWidth, spriteHeight, this._position.x, this._position.y, (0, _settings.canvasSettings).cellWidth, (0, _settings.canvasSettings).cellHeight);
        ctx.restore();
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","../utils/settings":"hBndc","./entity":"4kBdl"}],"4kBdl":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _settings = require("../utils/settings");
class Entity {
    ...
    _sprites;
    _type;
    constructor(x, y, type, assets, width = (0, _settings.canvasSettings).cellWidth, height = (0, _settings.canvasSettings).cellHeight){
        this._position = {
            x,
            y
        };
...
},{"../utils/settings":"hBndc","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"57eJ8":[function(require,module,exports) {
// Level data
...
class Wall extends (0, _entityDefault.default) {
    #type;
    ...
    draw(ctx) {
        ...
        switch(this.#type){
            case "breakable":
                spriteY = (0, _settings.canvasSettings).cellHeight;
                break;
            case "secret":
                spriteY = (0, _settings.canvasSettings).cellHeight * 2;
                break;
            default:
                spriteY = 0;
        }
...
},{"../utils/settings":"hBndc","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./entity":"4kBdl"}],"590U3":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _entity = require("./entity");
var _entityDefault = parcelHelpers.interopDefault(_entity);
...
class Explosive extends (0, _entityDefault.default) {
    #isHidden;
    #isActive;
    constructor(x, y, assets){
        super(x, y);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./entity":"4kBdl"}],"bFjVQ":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _entity = require("./entity");
var _entityDefault = parcelHelpers.interopDefault(_entity);
...
// - Can drop keys when defeated
class Guard extends (0, _entityDefault.default) {
    #speed;
    #detectionRange;
    #currentSprite;
    constructor(x, y, type, assets){
        super(x, y, type, assets, (0, _settings.entitySettings).enemyWidth, (0, _settings.entitySettings).enemyHeight);
        this.action = "idle";
        this.movement = [
            "down",
            "up",
        ...
        this.#speed = 1;
        this.#detectionRange = 5 * (0, _settings.canvasSettings).cellWidth;
    ...
    moveTowards(target, walls) {
        ...
        const nextPosition = {
            ...this._position,
            width: (0, _settings.canvasSettings).cellWidth / 2,
            height: (0, _settings.canvasSettings).cellHeight / 2
        };
        switch(this.movement){
            case "up":
                nextPosition.y -= this.#speed;
        ...
        const willCollideWithWalls = walls.some((wall)=>(0, _game.isColliding)(nextPosition, wall.getHitBox()));
        const willCollideWithPlayer = (0, _game.isColliding)(nextPosition, target);
    ...
    detectPlayer(playerPosition, walls) {
        ...
        if (distance <= this.#detectionRange) {
            ...
            for(let i = 0; i < distance; i += (0, _settings.canvasSettings).cellWidth / 2){
                checkPosition.x += step.x * ((0, _settings.canvasSettings).cellWidth / 2);
                checkPosition.y += step.y * ((0, _settings.canvasSettings).cellWidth / 2);
                if (walls.some((wall)=>(0, _game.isColliding)(checkPosition, wall.getHitBox()))) return false; // Wall blocking the line of sight
            }
...
},{"../utils/settings":"hBndc","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./entity":"4kBdl","../utils/game":"jBBaN"}],"14cf6":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _entity = require("./entity");
var _entityDefault = parcelHelpers.interopDefault(_entity);
...
// - Can drop keys when destroyed
class Obstacle extends (0, _entityDefault.default) {
    #health;
    #type;
    constructor(x, y, type, assets){
        super(x, y);
...
},{"../utils/settings":"hBndc","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./entity":"4kBdl"}],"7DUBa":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _entity = require("./entity");
var _entityDefault = parcelHelpers.interopDefault(_entity);
...
class Powerup extends (0, _entityDefault.default) {
    #collected;
    constructor(x, y, type, assets){
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./entity":"4kBdl"}],"lIWLe":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _entity = require("./entity");
var _entityDefault = parcelHelpers.interopDefault(_entity);
...
// - Properties: position
// - Methods: collect (mark as collected), update, draw
class Exit extends (0, _entityDefault.default) {
    constructor(x, y, assets){
...
},{"./entity":"4kBdl","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"92Yef":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
// Game Over screen
...
},{"4789fa1a7eb3f7ec":"lgJ39"}],"2Rkrn":[function(require,module,exports) {
// handle the screens
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["aAwE2","6JHOc"], "6JHOc", "parcelRequiref92b")
